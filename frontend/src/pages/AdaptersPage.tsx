  ...
  return (
    <div className="space-y-5 lg:space-y-6">
      <Card>
        <CardHeader className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-default-900">
            <Icon icon={plugCircleBold} fontSize={16} aria-hidden="true" />
          ...
          <div className="flex gap-2">
            <Button
              color="success"
              variant="flat"
              startContent={<Icon icon={playBold} fontSize={14} />}
            ...
            <Button
              color="danger"
              variant="flat"
              startContent={<Icon icon={stopBold} fontSize={14} />}
                ...
                <CardBody className="flex flex-row items-center justify-between gap-3">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <Icon icon={plugCircleBold} fontSize={14} className="text-primary" />
      ...
      <Card>
        <CardHeader className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-default-900">
            <Icon icon={settingsBold} fontSize={16} aria-hidden="true" />
        ...
        <CardBody className="space-y-5">
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-sm font-medium text-default-700">
              <Icon icon={plugCircleBold} fontSize={14} aria-hidden="true" />
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            <div className="rounded-2xl border border-default-200 bg-default-50 p-4 space-y-3 shadow-sm">
              <div className="flex items-center gap-2 font-semibold text-default-900">
                <Icon icon={cpuBoltBold} fontSize={16} aria-hidden="true" />
                <span>OneBot</span>
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                <Input
                  label="Host"
                  startContent={<Icon icon={server2Bold} fontSize={16} className="text-default-500" aria-hidden="true" />}
                ...
                <Input
                  label="Port"
                  type="number"
                  startContent={<Icon icon={hashtagBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
                  value={String(form.onebot_port ?? 2290)}
                  onValueChange={v => setForm(f => ({ ...f, onebot_port: Number(v) }))}
                />
                <Input
                  label="Access Token"
                  startContent={<Icon icon={keyBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
            ...
            <div className="rounded-2xl border border-default-200 bg-default-50 p-4 space-y-3 shadow-sm">
              <div className="flex items-center gap-2 font-semibold text-default-900">
                <Icon icon={sendSquareBold} fontSize={16} aria-hidden="true" />
                <span>Telegram</span>
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                <Input
                ...
                <Input
                  ...
                  startContent={<Icon icon={clockCircleBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
                  type="number"
            ...
            <div className="rounded-2xl border border-default-200 bg-default-50 p-4 space-y-3 shadow-sm">
              <div className="flex items-center gap-2 font-semibold text-default-900">
                <Icon icon={chatDotsBold} fontSize={16} aria-hidden="true" />
                <span>WeChat</span>
              </div>
              <Input
                label="Endpoint"
                startContent={<Icon icon={cloudBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
          ...
          <div className="rounded-2xl border border-default-200 bg-default-50 p-4 space-y-3 shadow-sm">
            <div className="flex items-center gap-2 font-semibold text-default-900">
              <Icon icon={magicStick2Bold} fontSize={16} aria-hidden="true" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <Input
                ...
                type="number"
                startContent={<Icon icon={chart2Bold} fontSize={16} className="text-default-500" aria-hidden="true" />}
              ...
              <Input
                ...
                type="number"
                startContent={<Icon icon={cpuBoltBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
              ...
              <Input
                ...
                type="number"
                startContent={<Icon icon={chatDotsBold} fontSize={16} className="text-default-500" aria-hidden="true" />}
              ...
              <Input
                ...
                startContent={<Icon icon={code2Bold} fontSize={16} className="text-default-500" aria-hidden="true" />}
